...
class MyAdmin(models.Model):
    ...
    is_superadmin = models.BooleanField(verbose_name="是否是超级管理员", default=False)
    class Meta:
        verbose_name = "管理员"
        db_table = "管理员表"
...
class Task(models.Model):
    ...
    user = models.ForeignKey(verbose_name="负责人", to="UserInfo", to_field="user_id", null=True, blank=True,
